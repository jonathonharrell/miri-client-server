# Generated on 2015-07-24 using generator-angular-fullstack 2.1.0
'use strict'
  ...
  grunt.initConfig
    ...
    ngconstant:
      options:
        ...
        name: 'config'
      development:
        options: dest: '<%= yeoman.client %>/scripts/config.js'
        constants: ENV:
          name: 'development'
          api: 'localhost:8080'
      production:
    ...
    cdnify: dist: html: [ '<%= yeoman.dist %>/public/*.html' ]
    copy:
      dist: files: [
        {
          expand: true
    ...
    stylus: server:
      options:
        ...
        'include css': true
      files: '.tmp/app/app.css': '<%= yeoman.client %>/app/app.styl'
    ...
    injector:
      ...
      stylus:
        options:
          ...
          starttag: '// injector'
          endtag: '// endinjector'
        files: '<%= yeoman.client %>/app/app.styl': [
